...
export const getTask = async (id) => {
    const res = await axios.get(`${API_URL}/tasks/${id}`, authHeader());
    return res.data;
};
...
export const addLecture = async (taskId, lecture) => {
    const res = await axios.post(`${API_URL}/tasks/${taskId}/lectures`, lecture, authHeader());
    return res.data;
};
